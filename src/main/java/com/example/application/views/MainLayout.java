...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Theming Workshop");
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Components", ComponentsView.class, LineAwesomeIcon.CODE_SOLID.create()));
        nav.addItem(new SideNavItem("Checkout Form", CheckoutFormView.class, LineAwesomeIcon.CREDIT_CARD.create()));
        nav.addItem(
                new SideNavItem("Grid with Filters", GridwithFiltersView.class, LineAwesomeIcon.TABLE_SOLID.create()));
